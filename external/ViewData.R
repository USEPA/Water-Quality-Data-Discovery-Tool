                         ...
                         tabsetPanel(type = "tabs",
                             ...
                             tabPanel("Table",
                                      ...
                                      fluidRow(column(5), column(2, downloadButton("save_map_data", "Save Data")),
                                               bsPopover("save_map_data", "Save Data", "Click to download a .csv file containing the data being viewed.",
                                                         "top", trigger = "hover", options = list(container = "body"))),
                                      br(),
                            ...
                            h5("* To populate the tabs 'Station Summary' and 'Parameter/Unit Summary', please select a station using the panel located on the map."),
                            br(),
                            br(),
                            br(),
                            br()))))
